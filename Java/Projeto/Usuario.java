...
public class Usuario {
    ...
    private int idade;
     ...
     //Declaração de criação da lista usuario
    ...
    public Usuario() {
     ...
     //Metódo cadastar, nesse metódo é possível cadastrar usuários;
    ...
    //Metódo registro de usuário, esse metódo é usado para ler os dados informados e 
    ...
    // Metódo usado para montar o menu específico do usuário
    ...
    //Metódo usado para consultar os usuários cadastrados;
    ...
    // Metódo usado para excluir os usuários cadastrados
    ...
    // Metódo para alterar os usuários cadastrados
