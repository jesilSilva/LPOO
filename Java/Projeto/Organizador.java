...
public class Organizador {
    ...
    //Declaração de criação da lista organizador
    ...
    //Metódo cadastar, nesse metódo é possível cadastrar organizadores;
     ...
     //Metódo registro de organizadores, esse metódo é usado para ler os dados informados e 
    // inseri-lós no metódo de cadastro;
    public void registroOrganizador() {
        Organizador o = new Organizador();
    ...
    // Metódo usado para montar o menu específico do organizador
    ...
    //Metódo usado para consultar os organizadores cadastrados;
    public ArrayList<Organizador> consultar(ArrayList<Organizador> organizador,String nome, int codigoOrganizador, String eventoCriado, String descrição, int nivelOrganizador) {
     ...
     // Metódo usado para excluir os organizadores cadastrados
    ...
    // Metódo para alterar os organizadores cadastrados
